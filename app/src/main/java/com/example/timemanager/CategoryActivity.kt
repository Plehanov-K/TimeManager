...
import com.example.timemanager.ui.events.EventsViewModel
...
class CategoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        MDate.date.observe(this, Observer {
            toolBarDateText.text = it.toString().substringBefore(" ")
        })
        ...
        eventsViewModel.tempEvent.observe(this, Observer {
        ...
        buttonEditTitleText.setOnClickListener {
            ...
            editText.setText(eventsViewModel.tempEvent.value?.name)
            MaterialAlertDialogBuilder(this, R.style.ColorPickerDialogTheme)
                ...
                .setPositiveButton(resources.getString(R.string.buttonOk)) { dialog, _ ->
                    eventsViewModel.tempEvent.value?.eventId?.let { it1 ->
                        eventsViewModel.updateEventParamNameDb(
        ...
        buttonEditColor.setOnClickListener {
            ColorPickerDialogBuilder
                ...
                .setPositiveButton(getString(R.string.buttonOk)) { dialog, selectedColor, allColors ->
                    eventsViewModel.tempEvent.value?.eventId?.let { it1 ->
                        eventsViewModel.updateEventParamColorDb(
        ...
        btnAddEventToday.setOnClickListener {
            ...
            eventsViewModel.dayTimeInMinutes.value?.let { time ->
                if (time - eventTimeInMinutes >= 0
                ) {
                    eventsViewModel.saveEventTodayToDb(
                        eventTimeInMinutes,
    ...
    fun onClickButton(view: View) {
        eventsViewModel.openBottomSheet(view.id)
    }
